...
namespace LanguageSchool.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,SchoolYearId,Result,SertificatId,RegData")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,SchoolYearId,Result,SertificatId,RegData")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
